...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        // Dar tiempo al AuthContext para actualizar el estado
        await new Promise(resolve => setTimeout(resolve, 300));
        
        // Verificar role para redirigir
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm font-semibold text-blue-800 mb-2">🎯 Credenciales de prueba:</p>
            <p className="text-xs text-blue-700">Email: demo@sneakerspro.com</p>
