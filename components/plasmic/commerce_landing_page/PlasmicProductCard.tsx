...
import Price from "../../Price"; // plasmic-import: rRlQikzkbUR7/component
...
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: 4RHzY59sfKRe/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox___94ERb, {
              [sty.freeBoxsmall___94ERbLozPx]: hasVariant(
                $state,
                "small",
                "small"
              )
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__nOrks, {
            [sty.freeBoxsmall__nOrksLozPx]: hasVariant($state, "small", "small")
          })}
        >
          <div className={classNames(projectcss.all, sty.freeBox__tAVN)}>
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Rating
                  className={classNames("__wab_instance", sty.rating__kzPwk)}
                />
              ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__d1IG)}>
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <div
