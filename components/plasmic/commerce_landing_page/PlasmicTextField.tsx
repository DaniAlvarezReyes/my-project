...
import Label from "../../Label"; // plasmic-import: lX9I6iaiTE3G/component
import TextInput2 from "../../TextInput2"; // plasmic-import: 3ID7ie-2Imld/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: _N-kONQKn6TA/component
import Description from "../../Description"; // plasmic-import: VGL-W48pzERS/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: fbA-hC7afB8_/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__zLyAy, {
          [sty.freeBoxiconEnd__zLyAyLnIzw]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__zLyAyBMgkd]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__zLyAydI4Ij]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__mt9Z, {
            [sty.freeBoxiconStart__mt9ZbMgkd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__mt9ZdI4Ij]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__oh2N3)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__yDGs7, {
            [sty.freeBoxiconEnd__yDGs7LnIzw]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__yDGs7BMgkd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__vSwD4)}
                role={"img"}
              />
            ),
