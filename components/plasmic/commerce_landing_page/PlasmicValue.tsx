...
import sty from "./PlasmicValue.module.css"; // plasmic-import: Dm-3LNFrAR7d/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: FZo28VB5xzpI/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__iT5Wu, {
          [sty.freeBoxcenter__iT5WuTgQaW]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom__iT5WuRKnDk]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox___2QKdt)}>
          {renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__f4XIm)}
                role={"img"}
              />
            ),
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___2NkF4, {
          [sty.freeBoxcenter___2NkF4TgQaW]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton___2NkF4SrUq1]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__rwHek, {
            [sty.freeBoxcenter__rwHektgQaW]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__rwHeksrUq1]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicValue__VariantsArgs, ReservedPropsType> &
