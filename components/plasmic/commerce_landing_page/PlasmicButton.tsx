...
import sty from "./PlasmicButton.module.css"; // plasmic-import: TiyCgqcAp_g5/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__a0Llq, {
          [sty.freeBoxcolor_neutral__a0LlQwDfEj]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__a0Llqc9VxmGtSkJ]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__a0LlQng8Ag]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__a0LlqEc9Tn]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__a0Llq5SiDg]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__a0Llq6X95E]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__a0LlqVvAqP]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__a0LlQgtSkJ]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__qicpf, {
            [sty.freeBoxcolor_neutral__qicpFwDfEj]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__qicpf3XXuH]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__qicpfEc9Tn]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__qicpf6X95E]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__qicpfVvAqP]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__qicpFgtSkJ]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__qicpfmGso0WDfEj]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__gxnpt)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ueQ7S, {
            [sty.freeBoxiconEnd__ueQ7SgjQio]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__ueQ7SEc9Tn]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__ueQ7S6X95E]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__ueQ7SVvAqP]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__t8KVn)}
                role={"img"}
              />
            ),
